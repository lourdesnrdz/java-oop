...
//                    showPatientMenu();
    ...
    private static void authUser(int userType){
        ...
        patiens.add(new Patient("Anahi Salgado", "anahi@mail.com"));
        patiens.add(new Patient("Roberto Rodriguez", "roberto@mail.com"));
        patiens.add(new Patient("Carlos Sanchez", "carlos@mail.com"));
